...
gmt grdimage -Q -R$OVERVIEW_REGION $POZO_DEM -I$POZO_DEM_HS -C$CPT -Jx$OVERVIEW_SCALE -V -K -Xc -Yc --COLOR_BACKGROUND=white > $POSTSCRIPT1 
...
gmt pstext catchment1.txt -R$OVERVIEW_REGION -Jx$OVERVIEW_SCALE -Gwhite -Wthin,blue -D-2c/+0.5cv -F+f16p,Helvetica,blue+j -V -O -K  >> $POSTSCRIPT1
gmt pstext catchment2.txt -R -Jx$OVERVIEW_SCALE -Gwhite -Wthick,red -D-1c/+0.5cv -F+f16p,Helvetica,red+j -V -O -K  >> $POSTSCRIPT1
gmt pstext catchment3.txt -R -Jx$OVERVIEW_SCALE -Gwhite -Wthick,green -D4c/-1cv -F+f16p,Helvetica,green+j -V -O -K  >> $POSTSCRIPT1
gmt pstext catchment4.txt -R -Jx$OVERVIEW_SCALE -Gwhite -Wthick,black -D-1c/+2cv -F+f16p,Helvetica,black+j -V -O -K  >> $POSTSCRIPT1
...
#add length scale
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=9p -LjRB+c32:34N+f+w1k+l1:20,000+u+o0.2i --FONT_LABEL=10p >> $POSTSCRIPT1
...
ticks=a5f5/a5f5
PROJECTION=M2
gmt psbasemap -Bp2dSEnw -Ju11N/1:3000000 -R$RANGE -P -K -V -X200c -Y10c --FONT_ANNOT_PRIMARY=9p --FONT_LABEL=10p >> $POSTSCRIPT1
