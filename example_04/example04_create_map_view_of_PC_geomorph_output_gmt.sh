...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT1
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$DEM_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+lMeter --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT1
#creating map insert (only for first map)
RANGE=-122/-118/32/36
PROJECTION=M2
gmt psbasemap -Bp2dSEnw  -Ju${UTM_ZONE}/1:20000000 -R$RANGE -O -K -V -X1c -Y5c --FONT_ANNOT_PRIMARY=9p >> $POSTSCRIPT1
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT2
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$DEM_DIFF_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+lMeter --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O >> $POSTSCRIPT2
...
gmt makecpt -T0/2/0.05 -D  -Cplasma >$SLOPE_CPT
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT3
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$SLOPE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Slope-P1" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O >> $POSTSCRIPT3
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT3b
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$SLOPE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Slope-P2" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O >> $POSTSCRIPT3b
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT3rmse
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$RMSE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"P1 RMSE (m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O >> $POSTSCRIPT3rmse
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT3brmse
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$RMSE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"P2 RMSE (m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O >> $POSTSCRIPT3brmse
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT4
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$CURVATURE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Curvature (1/m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT4
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT4b
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$CURVATURE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Curvature (1/m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT4b
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT4c
gmt psscale -R -J -DjTC+o-1.0c/0.3c/+w6c/0.3c+h -C$CURVATURE_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Curvature (1/m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT4c
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT5
gmt psscale -R -J -DjTC+o-2.0c/0.3c/+w6c/0.3c+h -C$NRLIDARPTS_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Nr. of points/area" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT5
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT6
gmt psscale -R -J -DjTC+o-2.0c/0.3c/+w6c/0.3c+h -C$DZ_STDDEV_GRD_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Dz. std. dev. (m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT6
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT7
gmt psscale -R -J -DjTC+o-1.5c/0.3c/+w6c/0.3c+h -C$DZ_R9010p_GRD_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Dz. 10-90p (m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT7
...
gmt psbasemap -R -J -O -K --FONT_ANNOT_PRIMARY=10p -LjRB+c34:36N+f+w${LENGTHScale_length_km}k+l${J_SCALE}+u+o0.5c --FONT_LABEL=10p >> $POSTSCRIPT8
gmt psscale -R -J -DjTC+o-2.0c/0.3c/+w6c/0.3c+h -C$DZ_IQR_GRD_CPT -I -F+gwhite+r1p+pthin,black -Baf -By+l"Dz. IQR (m)" --FONT=12p --FONT_ANNOT_PRIMARY=12p --MAP_FRAME_PEN=1 --MAP_FRAME_WIDTH=0.1 -O -K >> $POSTSCRIPT8
